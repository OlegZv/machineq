...
#     DeviceCreate,
# )
# from machineq.core.device_profile.api import SyncDeviceProfiles, AsyncDeviceProfiles
# from machineq.core.device_profile.models import DeviceProfileDevicesUpdate


# @pytest.fixture
# async def device_profiles_api(client) -> SyncDeviceProfiles | AsyncDeviceProfiles:
...
#     async def test_get_all(self, device_profiles_api):
